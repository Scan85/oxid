<?php /* Smarty version 2.6.28, created on 2017-02-02 13:24:43
         compiled from tools_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'tools_list.tpl', 1, false),array('modifier', 'oxwordwrap', 'tools_list.tpl', 52, false),array('modifier', 'oxaddslashes', 'tools_list.tpl', 76, false),array('function', 'oxmultilang', 'tools_list.tpl', 28, false),)), $this); ?>
...
<div id="liste">
    ...
    <?php if (isset ( $this->_tpl_vars['blViewSuccess'] )): ?>
    <tr>
        <td class="editnavigation">
            <?php if ($this->_tpl_vars['blViewSuccess']): ?>
            <?php echo smarty_function_oxmultilang(array('ident' => 'TOOLS_LIST_UPDATEVIEWSSECCESS'), $this);?>

            <?php else: ?>
            <?php echo smarty_function_oxmultilang(array('ident' => 'TOOLS_LIST_UPDATEVIEWSFAILED'), $this);?>
