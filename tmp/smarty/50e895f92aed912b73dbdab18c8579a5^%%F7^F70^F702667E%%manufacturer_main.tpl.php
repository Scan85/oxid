<?php /* Smarty version 2.6.28, created on 2017-02-02 13:24:06
         compiled from manufacturer_main.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'manufacturer_main.tpl', 1, false),array('function', 'oxmultilang', 'manufacturer_main.tpl', 42, false),array('function', 'oxinputhelp', 'manufacturer_main.tpl', 42, false),)), $this); ?>
...
">
<input type="hidden" name="editval[oxmanufacturers__oxid]" value="<?php echo $this->_tpl_vars['oxid']; ?>
">
<input type="hidden" name="language" value="<?php echo $this->_tpl_vars['actlang']; ?>
">
    ...
    <td valign="top" class="edittext">
        ...
        <table cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
                ...
                <td class="edittext">
                <input class="edittext" type="checkbox" name="editval[oxmanufacturers__oxactive]" value='1' <?php if ($this->_tpl_vars['edit']->oxmanufacturers__oxactive->value == 1): ?>checked<?php endif; ?> <?php echo $this->_tpl_vars['readonly']; ?>
>
            ...
            <tr>
                ...
                <td class="edittext">
                <input type="text" class="editinput" size="40" maxlength="<?php echo $this->_tpl_vars['edit']->oxmanufacturers__oxtitle->fldmax_length; ?>
" id="oLockTarget" name="editval[oxmanufacturers__oxtitle]" value="<?php echo $this->_tpl_vars['edit']->oxmanufacturers__oxtitle->value; ?>
...
>
            ...
            <tr>
                ...
                <td class="edittext">
                <input type="text" class="editinput" size="40" maxlength="<?php echo $this->_tpl_vars['edit']->oxmanufacturers__oxshortdesc->fldmax_length; ?>
" name="editval[oxmanufacturers__oxshortdesc]" value="<?php echo $this->_tpl_vars['edit']->oxmanufacturers__oxshortdesc->value; ?>
" <?php echo $this->_tpl_vars['readonly']; ?>
>
            ...
            <tr>
                ...
                <td class="edittext">
                <input type="text" class="editinput" size="25" maxlength="<?php echo $this->_tpl_vars['edit']->oxmanufacturers__oxicon->fldmax_length; ?>
" name="editval[oxmanufacturers__oxicon]" value="<?php echo $this->_tpl_vars['edit']->oxmanufacturers__oxicon->value; ?>
" <?php echo $this->_tpl_vars['readonly']; ?>
>
            ...
            <tr>
                <td class="edittext">
                <?php echo smarty_function_oxmultilang(array('ident' => 'MANUFACTURER_MAIN_ICONUPLOAD'), $this);?>
...
, <?php echo smarty_function_oxmultilang(array('ident' => 'GENERAL_MAX_PICTURE_DIMENSIONS'), $this);?>
                ...
                <td class="edittext">
                <input class="editinput" name="myfile[MICO@oxmanufacturers__oxicon]" type="file" <?php echo $this->_tpl_vars['readonly']; ?>
>
                <?php echo smarty_function_oxinputhelp(array('ident' => 'HELP_MANUFACTURER_MAIN_ICONUPLOAD'), $this);?>
...
" onClick="Javascript:document.myedit.fnc.value='save'"" <?php echo $this->_tpl_vars['readonly']; ?>
 <?php if (! $this->_tpl_vars['edit']->oxmanufacturers__oxtitle->value && ! $this->_tpl_vars['oxparentid']): ?>disabled<?php endif; ?> <?php echo $this->_tpl_vars['readonly']; ?>
><br>
            </td>
        </tr>
...
" class="edittext" onclick="JavaScript:showDialog('&cl=manufacturer_main&aoc=1&oxid=<?php echo $this->_tpl_vars['oxid']; ?>
');" <?php echo $this->_tpl_vars['readonly']; ?>
>
    <?php endif; ?>
    </td>
